          ...
          <div className="relative bg-white p-6 rounded-2xl z-50 w-full max-w-md shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4">
                  <div className="text-sm text-gray-500 mb-2">Выберите цвет:</div>
                  <div className="flex flex-wrap gap-2">
                    {colors.map((item, index) => (
                      <button
                        onClick={() => { setColor(item); setWarn(""); }}
                        key={index}
                ...
                {sizes && sizes.length > 0 && (
                  <div className="mt-4">
                    <div className="text-sm text-gray-500 mb-2">Выберите размер:</div>
                    <div className="flex flex-wrap gap-2">
                      {sizes.map((item, index) => (
                        <button
                          key={index}
                          onClick={() => { setSize(item); setWarn(""); }}
