    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
      <nav className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          {/* Logo */}
          <div
            className="text-xl md:text-2xl font-bold cursor-pointer flex-shrink-0"
            onClick={() => navigate("/")}
          >
            Max.Shop
          </div>
          ...
          >
            <div className="flex items-center bg-gray-100 rounded-xl px-3 py-2">
              <CiSearch className="text-gray-400 text-xl flex-shrink-0 mr-2" />
              <input
                value={searchQuery}
                onChange={(e) => {
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-3 pb-2 border-t border-gray-100 pt-3 flex flex-col gap-1">
            ...
            <div className="flex items-center bg-gray-100 rounded-xl px-3 py-2 mt-2">
              <CiSearch className="text-gray-400 text-xl mr-2 flex-shrink-0" />
              <input
                value={searchQuery}
